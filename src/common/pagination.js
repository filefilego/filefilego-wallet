...
class Pagination {
    ...
    paginate(data) {
        ...
        this.previous_page_url = this.previous_page ? this.setUrlPageNumber(this.previous_page) : null
        this.next_page_url = this.next_page ? this.setUrlPageNumber(this.next_page) : null
    ...
    paginationRange() {
        let c = this.page, m = this.last_page
