...
proto.node.ChanNode.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    adminsList: (f = jspb.Message.getRepeatedField(msg, 13)) == null ? undefined : f,
    postersList: (f = jspb.Message.getRepeatedField(msg, 14)) == null ? undefined : f,
 ...
 * @const
 */
proto.node.DataQueryResponse.repeatedFields_ = [6];
...
proto.node.DataQueryResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    totalfeesrequired: jspb.Message.getFieldWithDefault(msg, 2, ""),
    hash: jspb.Message.getFieldWithDefault(msg, 3, ""),
...
proto.node.DataQueryResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      var value = /** @type {string} */ (reader.readString());
      msg.setTotalfeesrequired(value);
      break;
    case 3:
      var value = /** @type {string} */ (reader.readString());
      msg.setHash(value);
...
proto.node.DataQueryResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getTotalfeesrequired();
  if (f.length > 0) {
    writer.writeString(
      2,
      f
...
/**
 * optional string TotalFeesRequired = 2;
 * @return {string}
 */
proto.node.DataQueryResponse.prototype.getTotalfeesrequired = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.node.DataQueryResponse} returns this
 */
proto.node.DataQueryResponse.prototype.setTotalfeesrequired = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
