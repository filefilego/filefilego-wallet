  ...
  <div>
                ...
                <tbody>
                  ...
                  <tr v-if="subchans.length == 0">
                    <div style="text-align:center; padding-top:15px;">
                      <div style="vertical-align:middle; background-color:#fff; border-radius:50%; border:2px solid #3e15ca; width:120px; height:120px; text-align:center; margin:0 auto;">
                        <svg
                          ...
                          y="0px"
                          viewBox="0 0 100 100"
                          style="margin-top:17px; enable-background:new 0 0 100 100;"
                          xml:space="preserve"
                        >
                          <g>
                            <path
                      ...
                      <h4
                        ...
                        class="header-display-1"
                      >
                        There isn't any sub-channel yet
                      </h4>
                    </div>
                  </tr>
                </tbody>
                  ...
                  <tr v-if="data.length == 0">
                    <div style="text-align:center; padding-top:15px;">
                      ...
                      <h4
                        ...
                        class="header-display-1"
                      >
                        This section contains no data yet
                      </h4>
                    </div>
                  </tr>
                </tbody>
    ...
    <div ref="search_providers" class="uk-modal" uk-modal="bg-close:false;">
      <div class="uk-modal-dialog uk-margin-auto-vertical">
        ...
        <div style="padding: 0" class="uk-modal-body">
          <div
            v-show="!loadingProviders && !loadingContractPrepare"
            class="uk-text-center"
            style="padding: 15px"
          >
...
<!-- 
          ...
          <div v-if="loadingContractPrepare">
            <div style="text-align: center; padding-top:20px;">
              <div class="lds-roller">
                <div></div>
                <div></div>
  ...
  methods: {
    ...
    async prepareContract(totalFees, hash, peerID) {
      ...
      try {
        ...
        this.prepareContractError = "Error while connecting to remote host"
      }
      this.loadingContractPrepare = false
    },
