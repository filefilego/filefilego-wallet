<template>
  <div>
    ...
    <div v-if="!entryMode && (node.node.NodeType == 3 || node.node.NodeType == 4) ">
      <div style="border-bottom: 1px solid #ddd" uk-grid>
        <div class="uk-width-expand">
          <h4
            v-if="node.node"
                ...
                <tbody>
                  <tr v-for="(ch, idx) in data" :key="ch.Hash">
                    <td style="width: 34px; vertical-align: middle">
                      ...
                      <span v-if="ch.NodeType == 2" style="font-size:1.7em;" class="icon-folder"></span>
                      <img v-if="ch.NodeType == 1" :src="nodeVector(ch)" style="width:32px; height:32px; font-size: 32px; vertical-align: middle; " />
                    </td>
                    <td>
                      <div style="vertical-align: middle">
                        <router-link
    ...
    <div v-if="!entryMode && !(node.node.NodeType == 3 || node.node.NodeType == 4) ">
      ...
      <div v-show="!loading && node.node.NodeType == 5" style="padding-top: 20px">
        <div style="border: 1px solid #e3e3e3; border-radius: 2px; padding:7px;">
          <div v-html="node.node.Description"></div>
        </div>
      </div>

      <div v-show="!loading && node.node.NodeType == 2" style="padding-top: 20px">
        <div style="border: 1px solid #e3e3e3; border-radius: 2px; padding:7px;">
          <div>
            directory
          </div>
      ...
      <div v-show="!loading && node.node.NodeType == 1" style="padding-top: 20px">
        <div style="border: 1px solid #e3e3e3; border-radius: 2px; padding:7px;">
          <div>
            file
          </div>
